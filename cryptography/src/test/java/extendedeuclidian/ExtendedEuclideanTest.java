...
class ExtendedEuclideanTest {
    ...
    void testNumbersWithGCDNotEqualsOne() {
        ExtendedEuclidean.ExtendedEuclideanResult result = ExtendedEuclidean.compute(
    ...
    @Test
    void testBezoutX() {
        ExtendedEuclidean.ExtendedEuclideanResult result = ExtendedEuclidean.compute(new BigInteger("21"),
        new BigInteger("17"));
        System.out.println(result.coefficientBezoutX);
    }
}