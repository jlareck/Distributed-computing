...
class AlgorithmXTEATEST {
    private static final AlgorithmXTEA xtea = new AlgorithmXTEA("124562sa35jfjgas".getBytes());
    ...
    @Test
    void decipherOfEncipherResult() {
        String s = "fdsafdsjbj215rfgkds";
        assertEquals(s, xtea.decipher(xtea.encipher(s)));
    }
}
