...
import extendedeuclidian.ExtendedEuclidean;
...
public class Montgomery {
    ...
    private static BigInteger redc(BigInteger a, BigInteger b, BigInteger n) {
        ...
        ExtendedEuclidean.ExtendedEuclideanResult euclideanResult = ExtendedEuclidean.compute(n, r);

        BigInteger t = a.multiply(b);
        BigInteger m = t
                .multiply(euclideanResult.getCoefficientBezoutX().negate())
